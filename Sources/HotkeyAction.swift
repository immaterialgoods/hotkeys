...
@objc 
public final class HotkeyAction: NSObject {
    @objc 
    ...
    @objc 
    public let fullResponderChain: Bool
    ...
    @objc 
    public init(identifier: String, action: Selector, target: AnyObject? = nil, consumeEvent: Bool = true, fullResponderChain: Bool = true) {
    ...
    @objc 
    public class func hotkeyAction(withIdentifier identifier: String, action: Selector) -> HotkeyAction {
        return HotkeyAction(identifier: identifier, action: action)
    }
    
    @objc 
    public class func hotkeyAction(withIdentifier identifier: String, action: Selector, target: AnyObject?) -> HotkeyAction {
        return HotkeyAction(identifier: identifier, action: action, target: target)
    }
    
    @objc 
    public class func hotkeyAction(withIdentifier identifier: String, action: Selector, consumeEvent: Bool) -> HotkeyAction {
