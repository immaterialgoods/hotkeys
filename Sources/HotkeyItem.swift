...
@objc 
public enum MenuAutoInclusionPolicy: Int {
...
@objc 
public enum HotkeyModifierRequirement: Int {
...
@objc 
public final class HotkeyItem: NSObject {
    ...
    @objc 
    public init(withTitle title: String, identifier: String, hotkey: HotkeyDescriptor? = nil, defaultHotkey: HotkeyDescriptor? = nil) {
        self.title = title
    ...
    @objc 
    public class func item(withTitle title: String, identifier: String) -> HotkeyItem {
    ...
    @objc 
    public class func item(withTitle title: String, identifier: String, defaultHotkey: HotkeyDescriptor?) -> HotkeyItem {
    ...
    @objc 
    public class func item(withTitle title: String, identifier: String, defaultHotkey: HotkeyDescriptor?, modifierRequirement: HotkeyModifierRequirement) -> HotkeyItem {
    ...
    @objc 
    public class func keyControlItem(withTitle title: String, identifier: String, defaultHotkey: HotkeyDescriptor?) -> HotkeyItem {
        let item = HotkeyItem(withTitle: title, identifier: identifier, hotkey: nil, defaultHotkey: defaultHotkey)
    ...
    @objc 
    public class func headerItem(withTitle title: String) -> HotkeyItem {
